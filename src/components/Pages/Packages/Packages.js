...
import Icontweo from 'assets/images/icon-21.png'
import Iconthree from 'assets/images/icon-31.png'
...
const Packages = () => {
  ...
  const [images, setimages] = useState([IconOne, Icontweo, Iconthree])
  ...
  const createOrder = async () => {
    ...
    try {
      ...
      toast(
        'You have subscribed a package, Please fill the form within 24 hours.',
        'success'
      )
        ...
        <div className='col-12'>
          <div className='content-body'>
            ...
            <div className='row text-center mb-3'>
                      ...
                      <div className='pricing'>
                        ...
                        <div className='pricingBody'>
                          <ul className='text-start m-0 p-0 pb-4'>
                            <li>{pkg.totalposts} Socail Media posts per</li>
                            {pkg.description &&
                              pkg.description.map((desc) => <li>{desc}</li>)}
                          </ul>
                          {/* <h2 className='fs-60 fw-bold ff-rubik text-orange mb-0'>
                            {pkg.totalposts} Total Posts
                          </h2> */}
                          {isAdmin ? (
                            <button
                          ...
                          {isAdmin ? null : activeSubscriptions.filter(
                              (s) => s.package === pkg._id
                            ).length > 0 ? (
                            <button
                              type='button'
              ...
              {isAdmin ? null : (
                <h6 className='fs-20 fw-semibold ff-rubik text-dark'>
                  Looking for a custom package? Dont worry! We've got you
                  covered. Feel free to{' '}
                  <Link
                    to={`/customer-feedback?prop1=true`}
