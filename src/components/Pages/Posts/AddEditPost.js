...
const AddEditPost = ({ mode, OrderId, PostId }) => {
  ...
  const HandleFileSubmit = async (e) => {
    if (images?.length >= 5) {
      return toast("Only 5 pictures could be uploaded", { ...toastConstant, type: "error" });
          ...
          ? images.map((image, index) => (
            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 mb-xl-0 mb-3">
              <div className="position-relative">
                ...
                />
                {isAdmin ? (
                  <span href="#" onClick={() => { deletefile(index) }} className="deleteBtn">
      ...
      <div className="row mb-3">
        ...
        <div className="col-md-6">
          ...
          {isAdmin && status !== 'Approved' ? (
            ...
            <select value={medium} onChange={(e) => setMedium(e.target.value)} className="form-control">
